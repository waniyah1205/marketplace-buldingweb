import Link from 'next/link';  // Ensure to use Link here
      ...
      <div className="h-auto w-full text-white mt-[24px] px-[32px] flex justify-between items-center">
        ...
        <div className="flex items-center gap-6">
          <nav className="flex items-center gap-6 font-normal text-[16px] leading-[21.6px] tracking-[0px]">
            {/* Search Button */}
            <button
              className="bg-blue-500 text-black-500 py-1 px-9 rounded-lg border border-gray-300 hover:bg-white hover:text-gray-500 focus:outline-none transition-all duration-300"
              aria-label="Search"
            >
              Search here
            </button>
            ...
            {/* Cart Link that opens in a new tab */}
